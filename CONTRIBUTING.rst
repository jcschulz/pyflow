...
Welcome to ``pyflow`` contributor's guide.
...
If you experience bugs or general issues with ``pyflow``, please have a look
...
You can help improve ``pyflow`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``pyflow`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pyflow``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n pyflow python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/pyflow.git
    cd pyflow
...
#. Install |pre-commit|_::
   ...
   ``pyflow`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pyflow
.. _issue tracker: https://github.com/<USERNAME>/pyflow/issues
.. <-- end -->
